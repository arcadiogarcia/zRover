...
/// <summary>
/// Lifecycle logger and periodic health-check for the Retriever.
...
public class Worker : BackgroundService
{
    ...
    {
        _logger.LogInformation("zRover.Retriever running");
        ...
        _logger.LogInformation("zRover.Retriever stopping");
    }
